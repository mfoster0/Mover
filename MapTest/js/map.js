...
//const API_TOKEN_Mapbox = 'pk.eyJ1IjoiY2hhY2VoaGgxMjMiLCJhIjoiY2xvYzQxbmVnMGRxeDJqcXJrMW5qcngzOCJ9.BP2VFjQPMOQlx4K5JXQfVw';
mapboxgl.accessToken = API_TOKEN_Mapbox;

//底部地图的设定51.513526864426666, -0.1271890523690548
const INITIAL_VIEW_STATE = {
    longitude: 0.1271890523690548,
...
map.on('load', () => {
    ...
    map.on('click', 'area-tree-layer', (e) => {
        var description = ("Area name: " + e.features[0].properties.wardname + '<br>' + "Coverage: " + e.features[0].properties.percancov + " %");
